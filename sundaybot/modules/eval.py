...
@sunday.on(sunday_on_cmd("eval"))
@sunday.on(sudo_cmd("eval", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    await sunday.edit_or_reply(event, "Processing ...")
    ...
    if len(final_output) > Config.MAX_MESSAGE_SIZE_LIMIT:
        ...
        await sunday.edit_or_reply(event, final_output)
